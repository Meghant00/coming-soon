...
$(function () {
  ...
  if (bgndKenburns1.length) {
    bgndKenburns1.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1600x1200-c1-kenburns-01.webp" },
        { src: "img/backgrounds/1600x1200-c1-kenburns-02.webp" },
        { src: "img/backgrounds/1600x1200-c1-kenburns-03.webp" },
      ],
      animation: [
        "kenburnsUp",
        "kenburnsDown",
  ...
  if (bgndKenburns2.length) {
    bgndKenburns2.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1600x1200-c2-kenburns-01.webp" },
        { src: "img/backgrounds/1600x1200-c2-kenburns-02.webp" },
        { src: "img/backgrounds/1600x1200-c2-kenburns-03.webp" },
      ],
      animation: [
        "kenburnsUp",
        "kenburnsDown",
  ...
  if (bgndKenburns3.length) {
    bgndKenburns3.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1600x1200-c3-kenburns-01.webp" },
        { src: "img/backgrounds/1600x1200-c3-kenburns-02.webp" },
        { src: "img/backgrounds/1600x1200-c3-kenburns-03.webp" },
      ],
      animation: [
        "kenburnsUp",
        "kenburnsDown",
  ...
  if (bgndKenburnsMono.length) {
    bgndKenburnsMono.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1600x1200-mono-kenburns-01.webp" },
        { src: "img/backgrounds/1600x1200-mono-kenburns-02.webp" },
        { src: "img/backgrounds/1600x1200-mono-kenburns-03.webp" },
      ],
      animation: [
        "kenburnsUp",
        "kenburnsDown",
